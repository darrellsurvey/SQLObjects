IF OBJECT_ID('CR_Reports.fairway_no_hyb_func') IS NOT NULL
    DROP FUNCTION [CR_Reports].[fairway_no_hyb_func];
GO
...
-- =============================================
CREATE FUNCTION [CR_Reports].[fairway_no_hyb_func] 
(	
	@FIRSTDAY date,
	@SID int
)
...
(
	...
	SELECT d.[Name] AS PLAYERNAME, [Wood Club Code] AS CLUBCODE, DCLUBCODE, [Wood Brand Code] AS BRAND, DBRANDCODE,
