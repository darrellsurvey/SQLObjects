IF OBJECT_ID('CR_Reports.Utility_Iron___Hybrid_Wood') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Utility_Iron___Hybrid_Wood];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Utility_Iron___Hybrid_Wood]
