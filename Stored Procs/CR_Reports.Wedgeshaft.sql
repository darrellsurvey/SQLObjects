IF OBJECT_ID('CR_Reports.Wedgeshaft') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Wedgeshaft];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Wedgeshaft]
...
SELECT a."Name" AS PLAYERNAME, CATEGORY, EXTRA, b."Shaft Club Code" AS CLUBCODE, DCLUBCODE, ISNULL(e."Mfgr Abbrev", e."Mfgr Descr") AS MFGR, DMFGRCODE,
