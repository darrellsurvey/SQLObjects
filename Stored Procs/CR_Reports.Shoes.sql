IF OBJECT_ID('CR_Reports.Shoes') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Shoes];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Shoes]
...
LEFT OUTER JOIN [LKP].[Manufacturer Codes and Desc] a ON SHOEBRAND = a.[Mfgr Code] 
