IF OBJECT_ID('CR_Reports.Gloves') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Gloves];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Gloves]
...
BEGIN
	...
	SET NOCOUNT ON;
	SELECT b.PLAYERNAME, CATEGORY, EXTRA, ISNULL(a.[Mfgr Abbrev], a.[Mfgr Descr]) AS GLOVEBRAND, DGLOVEBRAND
