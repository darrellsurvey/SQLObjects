IF OBJECT_ID('OptOut.Selection_GetNew_backup-4-26-26') IS NOT NULL
    DROP PROCEDURE [OptOut].[Selection_GetNew_backup-4-26-26];
GO
...
--where cte_Sponsors.Brand not in (select brand from #results)
...
-- select * from optout.selection
 ...
 --- exec optout.selection_getnew 'pingbruno', 'KOIVUN, JACKSON', 2026
GO
