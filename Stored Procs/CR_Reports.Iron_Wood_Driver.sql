IF OBJECT_ID('CR_Reports.Iron_Wood_Driver') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Iron_Wood_Driver];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Iron_Wood_Driver]
...
SELECT 'NAMENAMENAMENAMENAMENAME' AS PLAYERNAME, 'CAT' AS CATEROGY, 'SCHOOL SCHOOL' AS EXTRA,
