IF OBJECT_ID('CR_Reports.Woodshafts') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Woodshafts];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Woodshafts]
...
SELECT a.[Name] AS PLAYERNAME, CATEGORY, EXTRA, b.[Shaft Club Code] AS WOODCLUBCODE, DCLUBCODE, 
--wood info
...
--shaft info
b.[Shaft Club Code] AS SHAFTCLUBCODE, DCLUBCODE, 
...
ISNULL(j.[Matl Abbrev], j.[Matl Descr]) AS SHAFTMATL, b.DMATERIAL
...
LEFT OUTER JOIN LKP.[Material Codes and Descript] j ON b.[Shaft Mat'l Code] = j.[Matl Code]
--wood joins
...
execute CR_Reports.Woodshafts '4/8/2010', 26
