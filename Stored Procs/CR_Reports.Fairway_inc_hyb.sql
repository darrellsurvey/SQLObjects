IF OBJECT_ID('CR_Reports.Fairway_inc_hyb') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Fairway_inc_hyb];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Fairway_inc_hyb]
...
BEGIN
	...
	SELECT d.[Name] AS PLAYERNAME, CATEGORY, EXTRA, [Wood Club Code] AS CLUBCODE, DCLUBCODE, ISNULL(a.[Mfgr Abbrev], a.[Mfgr Descr]) AS BRAND, DBRANDCODE,
