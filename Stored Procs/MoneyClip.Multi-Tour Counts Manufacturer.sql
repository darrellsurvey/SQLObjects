...
from (SELECT [TOUR],[FIRST DAY],[Grip Mfgr Code] as [MANUFACTURER] FROM '
...
if CHARINDEX(',', @tourSort) > 0 
	SET @query = @query + '[Manufacturer] ASC'
else
