IF OBJECT_ID('CR_Reports.Glove_Shoe_Bag_Headgear') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Glove_Shoe_Bag_Headgear];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Glove_Shoe_Bag_Headgear]
