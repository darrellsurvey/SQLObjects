IF OBJECT_ID('CR_Reports.Ball_Iron_Wood_Driver') IS NOT NULL
    DROP PROCEDURE [CR_Reports].[Ball_Iron_Wood_Driver];
GO
...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Ball_Iron_Wood_Driver]
...
"Name" AS PLAYERNAME, CATEGORY, EXTRA, "Iron Club Code" AS IRONCLUBCODE, DCLUBCODE, a."Mfgr Descr" AS IRONBRAND, DBRANDCODE, b."Model Descr" AS IRONMODEL, DMODELCODE, d."PKey"
...
GROUP BY "Name", CATEGORY, EXTRA, "Iron Club Code", a."Mfgr Descr", b."Model Descr", d."PKey", DCLUBCODE, DBRANDCODE, DMODELCODE) AS I
