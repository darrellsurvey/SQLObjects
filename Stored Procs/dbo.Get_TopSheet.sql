IF OBJECT_ID('dbo.Get_TopSheet') IS NOT NULL
    DROP PROCEDURE [dbo].[Get_TopSheet];
GO

CREATE PROCEDURE [dbo].[Get_TopSheet]
...
(SELECT COUNT(CADDYHEADBRAND) FROM [Player_Master].[All] WHERE SID = @SID AND [FIRST DAY] = @FIRSTDAY) AS TOTAL

  FROM [Player_Master].[All]

  LEFT OUTER JOIN [LKP].[Manufacturer Codes and Desc] ON "Mfgr Code" = CADDYHEADBRAND
...
(SELECT COUNT(RAINGEARBRAND) FROM [Player_Master].[All] WHERE SID = @SID AND [FIRST DAY] = @FIRSTDAY) AS TOTAL
...
with cte_wood as (SELECT w.[Wood Brand Code], 

							s.[Shaft Mfgr Code], 

							w.[INDEX]

					FROM Player_Master.[Wood Detail] w

					inner join Player_Master.[Shaft Detail] s 

					on w.[Survey ID] = s.[Survey ID] and
						...
						s.[Shaft Equip Type] = 'WOOD'						 

					WHERE w."First Day" = @FIRSTDAY AND w."Survey ID" = @SID and w.[Wood Club Code] = 'HYB')





SELECT C."Mfgr Descr" AS [Wood Brand], 

		S."Mfgr Descr" AS [Shaft Manufacturer],
...
LEFT OUTER JOIN LKP.[Manufacturer Codes and Desc] S ON [Shaft Mfgr Code] = S."Mfgr Code"

GROUP BY C."Mfgr Descr", S."Mfgr Descr"

ORDER BY [Wood Brand], COUNT(C."Mfgr Descr") desc, S."Mfgr Descr";
...
LEFT OUTER JOIN LKP.[Manufacturer Codes and Desc] S ON [Shaft Brand Code] = S."Mfgr Code"
...
with cte_wood as (SELECT w.[Wood Brand Code], 
					...
					WHERE w."First Day" = @FIRSTDAY AND w."Survey ID" = @SID and ISDRIVER = 1)
...
with cte_wood as (SELECT w.[Wood Brand Code], 
					...
					WHERE w."First Day" = @FIRSTDAY AND w."Survey ID" = @SID)
...
with cte_wood as (SELECT distinct i.[Iron Brand Code], 

							s.[Shaft Mfgr Code], 

							i.name

					FROM Player_Master.[Iron Detail] i

					inner join Player_Master.[Shaft Detail] s 

					on i.[Survey ID] = s.[Survey ID] and
						...
						s.[Shaft Equip Type] = 'IRON'						 

					WHERE i."First Day" = @FIRSTDAY AND i."Survey ID" = @SID and ISset = 1)





SELECT C."Mfgr Descr" AS [Iron Brand], 
...
LEFT OUTER JOIN LKP.[Manufacturer Codes and Desc] C ON [Iron Brand Code] = C."Mfgr Code"

LEFT OUTER JOIN LKP.[Manufacturer Codes and Desc] S ON [Shaft Mfgr Code] = S."Mfgr Code"

GROUP BY C."Mfgr Descr", S."Mfgr Descr"

ORDER BY [iron Brand], COUNT(C."Mfgr Descr") desc, S."Mfgr Descr";      
...
SELECT Name, [Iron Brand Code], [Shaft Mat'l Code] FROM IRONSETTABLE_SHAFT
...
SELECT Name, [Shaft Mfgr Code] from IRONSETTABLE_SHAFT
...
with cte_wood as (SELECT i.[Iron Brand Code], 
					...
					WHERE i."First Day" = @FIRSTDAY AND i."Survey ID" = @sid and i.[Iron Club Code] like '%^%')
...
SELECT Name, [Shaft Brand Code] from IRONSETTABLE_SHAFT
...
(SELECT COUNT("Shaft Mat'l Code") FROM [Player_Master].[Shaft Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Shaft Equip Type] = 'WEDG') AS TOTAL

  FROM [Player_Master].[Shaft Detail]

  LEFT OUTER JOIN [LKP].[Material Codes and Descript] ON "Matl Code" = "Shaft Mat'l Code" 

  WHERE [Survey ID]= @SID AND [First Day] = @FIRSTDAY AND [Shaft Equip Type] = 'WEDG'
...
(SELECT COUNT("Shaft Mfgr Code") FROM [Player_Master].[Shaft Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Shaft Equip Type] = 'WEDG') AS TOTAL
...
(SELECT COUNT("Shaft Brand Code") FROM [Player_Master].[Shaft Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Shaft Equip Type] = 'WEDG') AS TOTAL
...
with cte_wood as (SELECT w.[Wedge Brand Code], 
...
SELECT C."Mfgr Descr" AS [Wedge Brand], 
...
LEFT OUTER JOIN LKP.[Manufacturer Codes and Desc] C ON [Wedge Brand Code] = C."Mfgr Code"

LEFT OUTER JOIN LKP.[Manufacturer Codes and Desc] S ON [Shaft Mfgr Code] = S."Mfgr Code"

GROUP BY C."Mfgr Descr", S."Mfgr Descr"

ORDER BY [Wedge Brand], COUNT(C."Mfgr Descr") desc, S."Mfgr Descr";
...
(SELECT COUNT("Grip Mat'l Code") FROM [Player_Master].[Grip Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Grip Equip Type] = 'WEDG') AS TOTAL

  FROM [Player_Master].[Grip Detail]

  LEFT OUTER JOIN [LKP].[Material Codes and Descript] ON "Matl Code" = "Grip Mat'l Code" 

  WHERE [Survey ID]= @SID AND [First Day] = @FIRSTDAY AND [Grip Equip Type] = 'WEDG'
...
(SELECT COUNT("Grip Mfgr Code") FROM [Player_Master].[Grip Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Grip Equip Type] = 'WEDG') AS TOTAL
...
(SELECT COUNT("Grip Brand Code") FROM [Player_Master].[Grip Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Grip Equip Type] = 'WEDG') AS TOTAL
...
(SELECT COUNT("Grip Mat'l Code") FROM [Player_Master].[Grip Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Grip Equip Type] = 'PUTT') AS TOTAL
...
(SELECT COUNT("Grip Mfgr Code") FROM [Player_Master].[Grip Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Grip Equip Type] = 'PUTT') AS TOTAL
...
(SELECT COUNT("Grip Brand Code") FROM [Player_Master].[Grip Detail] WHERE "Survey ID" = @SID AND "First Day" = @FIRSTDAY AND [Grip Equip Type] = 'PUTT') AS TOTAL
