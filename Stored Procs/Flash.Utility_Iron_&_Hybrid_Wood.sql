IF OBJECT_ID('Flash.Utility_Iron_&_Hybrid_Wood') IS NOT NULL
    DROP PROCEDURE [Flash].[Utility_Iron_&_Hybrid_Wood];
GO
...
-- =============================================
CREATE PROCEDURE [Flash].[Utility_Iron_&_Hybrid_Wood]
...
INNER JOIN
(
SELECT PLAYERNAME, CLUBCODE AS IRONCLUBCODE, DCLUBCODE, a."Mfgr Descr" AS IRONBRAND, DBRANDCODE, b."Model Descr" AS IRONMODEL, DMODELCODE, "PKey"
FROM input.iron
