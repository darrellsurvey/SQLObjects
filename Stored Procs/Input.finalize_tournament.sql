IF OBJECT_ID('Input.finalize_tournament') IS NOT NULL
    DROP PROCEDURE [Input].[finalize_tournament];
GO

CREATE PROCEDURE [Input].[finalize_tournament]
	@SID integer,
	@FIRSTDAY date,
...
SELECT PKey, PLAYERNAME, SID, [FIRST DAY], ISDRIVER, NULL, CLUBCODE, DCLUBCODE, BRAND, DBRANDCODE, MODEL, DMODELCODE, MATERIAL, DMATERIAL, SIZE, DSIZECODE, MISC, DMISCCODE, NULL, NULL FROM (
...
SELECT PKey, PLAYERNAME, SID, [FIRST DAY], CLUBCODE, DCLUBCODE, BRAND, DBRANDCODE, MODEL, DMODELCODE, [TYPE], DTYPECODE, MATERIAL, DMATERIAL, SIZE, DSIZECODE, MISC, DMISCCODE, NULL, NULL FROM (
SELECT * FROM #PlayerMinInput inputnotable
LEFT OUTER JOIN
(
SELECT [PKey]
...
SELECT PKey, PLAYERNAME, SID, [FIRST DAY], ISSET, NULL, CLUBCODE, DCLUBCODE, BRAND, DBRANDCODE, MODEL, DMODELCODE, [TYPE], DTYPECODE, MATERIAL, DMATERIAL, SIZE, DSIZECODE, NULL, NULL FROM (
SELECT * FROM #PlayerMinInput inputnotable
LEFT OUTER JOIN
(
SELECT [PKey]
...
SELECT PKey, PLAYERNAME, SID, [FIRST DAY], CLUBCODE, DSEQUENCENO, BRAND, DBRANDCODE, MODEL, DMODELCODE, [TYPE], DTYPECODE, MATERIAL, DMATERIAL, SIZE, DSIZECODE, NULL, NULL FROM (
SELECT * FROM #PlayerMinInput inputnotable
LEFT OUTER JOIN
(
SELECT [PKey]
...
SELECT PKey, PLAYERNAME, SID, [FIRST DAY], SHAFTEQUIPTYPE, SHAFTCLUBCODE, DCLUBCODE, SHAFTMFGR, DMFGRCODE, SHAFTBRAND, DBRANDCODE, SHAFTMODEL, DMODELCODE, SHAFTFLEX, DSHAFTFLEX, [SHAFTTYPE], DTYPECODE, SHAFTMATL, DMATLCODE, NULL, NULL FROM (
SELECT * FROM #PlayerMinInput inputnotable
LEFT OUTER JOIN
(
SELECT [PKey]
...
SELECT PKey, PLAYERNAME, SID, [FIRST DAY], GRIPEQUIPTYPE, GRIPCLUBCODE, DCLUBCODE, GRIPMFGR, DMFGRCODE, GRIPBRAND, DBRANDCODE, GRIPMODEL, DMODELCODE, [GRIPTYPE], DTYPECODE, GRIPMATL, DMATERIAL, NULL, NULL FROM (
SELECT * FROM #PlayerMinInput inputnotable
LEFT OUTER JOIN
(
SELECT [PKey]
