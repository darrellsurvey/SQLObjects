...
-- =============================================
CREATE PROCEDURE [CR_Reports].[Headgear]
...
BEGIN
	...
	SET NOCOUNT ON;
	SELECT b.PLAYERNAME, CATEGORY, EXTRA, COALESCE(a.[Mfgr Abbrev], a.[Mfgr Descr]) AS HEADGEARBRAND, DHEADGEARBRAND

FROM [Player_Master].[All] b
LEFT OUTER JOIN [LKP].[Manufacturer Codes and Desc] a ON HEADGEARBRAND = a.[Mfgr Code] 
