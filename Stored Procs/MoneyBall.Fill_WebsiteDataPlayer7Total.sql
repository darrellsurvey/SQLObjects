IF OBJECT_ID('MoneyBall.Fill_WebsiteDataPlayer7Total') IS NOT NULL
    DROP PROCEDURE [MoneyBall].[Fill_WebsiteDataPlayer7Total];
GO

-- =============================================
-- Author:		Alex Roytman
-- Create date: 07/28/2025
-- Description:	Fill table MoneyBall.WebsiteDataPlayer7Total
-- =============================================

CREATE procedure [MoneyBall].[Fill_WebsiteDataPlayer7Total]
(
	@Tour varchar(25),
	@PGASeason integer,
	@SportTourId tinyint,
...
AS
Begin -- WebsiteDataPlayer7Total
Print 'Start WebsiteDataPlayer7Total'

--exec [MoneyBall].[Fill_WebsiteDataPlayer7Total] 'TGL', 2026,1,'20260205'
	
delete from MoneyBall.WebsiteDataPlayer7Total where PGASeason = @PGASeason and SportTourId = @SportTourId
...
SELECT w1.PlayerName, 
	   ...
	   case when coalesce(DSPoints, 0) = 0 then NULL else SSDSPoints * 1.0 / nullif(DSPoints,0) end as PortionOfEventTDueToSS,
...
Insert into MoneyBall.WebsiteDataPlayer7Total (PlayerName, PGASeason, Header, UserData, SportTourId)
...
Print 'Finished WebsiteDataPlayer7Total'; 
end  -- WebsiteDataPlayer7Total
GO
