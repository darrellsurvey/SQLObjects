IF OBJECT_ID('dbo.Bag') IS NOT NULL
    DROP VIEW [dbo].[Bag];
GO
...
SELECT     TOP (100) PERCENT Player_Master.TOURNAMENTS_TABLE.SID, Player_Master.TOURNAMENTS_TABLE.TYPE AS TOUR, 
                      ...
                      LKP.[Manufacturer Codes and Desc].[Mfgr Descr] AS BRAND, '' AS MODEL, '' AS SERIES, Player_Master.TOURNAMENTS_TABLE.TournamentId
FROM         Player_Master.[All] INNER JOIN
                      ...
                      LKP.[Manufacturer Codes and Desc] ON Player_Master.[All].BAGBRAND = LKP.[Manufacturer Codes and Desc].[Mfgr Code]
