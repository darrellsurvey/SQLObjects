IF OBJECT_ID('dbo.RangefindersCaddie') IS NOT NULL
    DROP VIEW [dbo].[RangefindersCaddie];
GO

CREATE VIEW [dbo].[RangefindersCaddie]
AS
SELECT     TOP (100) PERCENT Player_Master.TOURNAMENTS_TABLE.SID, Player_Master.TOURNAMENTS_TABLE.TYPE AS TOUR, 
                      ...
                      Player_Master.TOURNAMENTS_TABLE.[LAST DAY], Player_Master.[All].PLAYERNAME, LKP.[Manufacturer Codes and Desc].[Mfgr Descr] AS BRAND, '' AS MODEL, 
...
FROM         Player_Master.[All] INNER JOIN
                      ...
                      LKP.[Manufacturer Codes and Desc] ON Player_Master.[All].RANGECADDIEBRAND = LKP.[Manufacturer Codes and Desc].[Mfgr Code]
