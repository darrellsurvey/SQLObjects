IF OBJECT_ID('dbo.Shoes') IS NOT NULL
    DROP VIEW [dbo].[Shoes];
GO

CREATE VIEW dbo.Shoes
AS
...
FROM         Player_Master.[All] INNER JOIN
                      ...
                      LKP.[Manufacturer Codes and Desc] ON Player_Master.[All].SHOEBRAND = LKP.[Manufacturer Codes and Desc].[Mfgr Code]
