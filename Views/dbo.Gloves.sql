IF OBJECT_ID('dbo.Gloves') IS NOT NULL
    DROP VIEW [dbo].[Gloves];
GO

CREATE VIEW dbo.Gloves
AS
SELECT     TOP (100) PERCENT Player_Master.TOURNAMENTS_TABLE.SID, Player_Master.TOURNAMENTS_TABLE.TYPE AS TOUR, 
                      ...
                      Player_Master.TOURNAMENTS_TABLE.[FIRST DAY], Player_Master.[All].PLAYERNAME, LKP.[Manufacturer Codes and Desc].[Mfgr Descr] AS BRAND, '' AS MODEL, 
                      '' AS SERIES, Player_Master.TOURNAMENTS_TABLE.TournamentId
FROM         Player_Master.[All] INNER JOIN
                      ...
                      LKP.[Manufacturer Codes and Desc] ON Player_Master.[All].GLOVEBRAND = LKP.[Manufacturer Codes and Desc].[Mfgr Code]
