IF OBJECT_ID('dbo.Headgear') IS NOT NULL
    DROP VIEW [dbo].[Headgear];
GO

CREATE VIEW dbo.Headgear
AS
...
FROM         Player_Master.[All] INNER JOIN
                      ...
                      LKP.[Manufacturer Codes and Desc] ON Player_Master.[All].HEADGEARBRAND = LKP.[Manufacturer Codes and Desc].[Mfgr Code]
