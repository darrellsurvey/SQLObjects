IF OBJECT_ID('dbo.Sunglasses') IS NOT NULL
    DROP VIEW [dbo].[Sunglasses];
GO

CREATE VIEW dbo.Sunglasses
AS
...
FROM         Player_Master.[All] INNER JOIN
                      ...
                      LKP.[Manufacturer Codes and Desc] ON Player_Master.[All].GLASSESBRAND = LKP.[Manufacturer Codes and Desc].[Mfgr Code]
